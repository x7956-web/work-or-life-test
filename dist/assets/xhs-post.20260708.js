(function () {
  const copies = {
    card1: `第 1 张封面图\n\n顶部小字：\n想离开前，先看清自己卡在哪里\n\n主标题：\n你该换工作，\n还是换活法？\n\n副标题：\n很多问题，不是辞职能解决的。\n\n视觉：极简黑白风，一个人站在两个选择之间。左边象征继续上班和工作压力，右边象征换一种生活状态。不要使用外部图片，不要使用小红书水印。`,
    card2: `凭第一直觉去选，不要犹豫～\n\n1 如果突然给你三个月带薪假期，\n你第一反应更像：\n\nA. 终于可以好好休息了\nB. 去一个陌生城市待一段时间\nC. 学点一直想学的东西\nD. 认真想想以后的人生\n\n2 最近让你最疲惫的事情更接近：\n\nA. 永远做不完的工作\nB. 不断处理别人的情绪\nC. 日复一日的重复生活\nD. 不知道自己为什么努力`,
    card3: `3 如果未来三年，\n你的生活和现在一模一样。\n你的第一感受是：\n\nA. 可以接受\nB. 有点不甘心\nC. 开始焦虑\nD. 有种喘不过气的感觉\n\n4 你最近最常出现的状态是：\n\nA. 身体累\nB. 情绪累\nC. 对什么都提不起劲\nD. 总觉得人生卡住了\n\n5 看到别人辞职、换城市、转行的时候，\n你心里的真实想法更像：\n\nA. 太冲动了\nB. 挺羡慕的\nC. 我也想试试\nD. 我好像早就想离开了`,
  ...
  function renderCoverCard() {
    return `
      <article class="xhs-card xhs-cover-card" aria-label="小红书封面图">
        ...
        <div class="xhs-choice-scene" aria-hidden="true">
          <div class="xhs-exit xhs-work-exit">
            <span class="xhs-exit-label">继续上班</span>
            <span class="xhs-stack"></span>
            <span class="xhs-stack small"></span>
          </div>
          <div class="xhs-person"><span></span></div>
          <div class="xhs-exit xhs-life-exit">
            <span class="xhs-exit-label">换种活法</span>
            <span class="xhs-sun"></span>
            <span class="xhs-road"></span>
          </div>
        </div>
